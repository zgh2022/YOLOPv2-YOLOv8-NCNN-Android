...
int NdkCamera::open(int _camera_facing) {
    ...
    // open camera
    {
        ...
        camera_device_state_callbacks.onDisconnected = nullptr;
        camera_device_state_callbacks.onError = nullptr;
    ...
    // capture session
    {
        ...
        camera_capture_session_state_callbacks.onActive = nullptr;
        camera_capture_session_state_callbacks.onReady = nullptr;
        camera_capture_session_state_callbacks.onClosed = nullptr;
        ...
        camera_capture_session_capture_callbacks.onCaptureCompleted = nullptr;
        camera_capture_session_capture_callbacks.onCaptureFailed = nullptr;
        camera_capture_session_capture_callbacks.onCaptureSequenceCompleted = nullptr;
        camera_capture_session_capture_callbacks.onCaptureSequenceAborted = nullptr;
